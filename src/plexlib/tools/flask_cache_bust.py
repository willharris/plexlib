...
# https://raw.githubusercontent.com/ChrisTM/Flask-CacheBust/master/flask_cache_bust/__init__.py
#
    ...
    for dirpath, dirnames, filenames in os.walk(static_folder):
        for filename in filenames:
            ...
            with open(rooted_filename, 'r') as f:
                file_content = f.read().encode(encoding='utf8', errors='replace')
                version = hashlib.md5(file_content).hexdigest()[:7]
